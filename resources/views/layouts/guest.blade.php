...
<body class="antialiased bg-cream text-slate-900 selection:bg-[#4E7D5B] selection:text-white">
    @if ($cinematic)
        {{ $slot }}
    @else
            ...
            <div class="relative w-full max-w-lg">
                <div class="mb-12 text-center">
                    <a href="{{ route('home') }}" class="inline-flex flex-col items-center gap-4">
                        ...
                        <span class="font-serif text-3xl tracking-tight text-slate-900">SmartEvent</span>
                    </a>
                </div>

                <div class="premium-card bg-white p-12 shadow-2xl shadow-[#4E7D5B]/5">
                    {{ $slot }}
                </div>
