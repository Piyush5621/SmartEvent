            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-20 gap-4">
                    ...
                    <nav class="hidden md:flex items-center gap-4">
                        <a href="{{ route('events.index') }}" class="text-sm font-semibold text-slate-700 hover:text-indigo-600 transition">Explore Events</a>
                        <a href="{{ route('about') }}" class="text-sm font-semibold text-slate-700 hover:text-indigo-600 transition">About</a>
                        <a href="{{ route('blog') }}" class="text-sm font-semibold text-slate-700 hover:text-indigo-600 transition">Blog</a>
                        <a href="{{ route('help') }}" class="text-sm font-semibold text-slate-700 hover:text-indigo-600 transition">Help</a>
                        <a href="{{ route('contact') }}" class="text-sm font-semibold text-slate-700 hover:text-indigo-600 transition">Contact</a>
                    </nav>
                    <div class="flex items-center gap-3">
                        @auth
                            <a href="{{ route('dashboard') }}" class="text-sm font-semibold text-slate-700 hover:text-indigo-600 transition">Dashboard</a>
                        @else
